 ...
 * @type {string}
 */
export const THEME_COLOR: string = "#DBB039";
 ...
 * @type {string}
 */
export const BACKGROUND_COLOR: string = "#222222";
 ...
 * @type {string}
 */
export const DEFAULT_TITLE: string = "Stark House";
 ...
 * @type {string}
 */
export const DEFAULT_DESCRIPTION: string = "Stark House to producent carportów, dzięki którym operatywni przedsiębiorcy optymalizują koszty energii i zarabiają na przestrzeni parkingowej";
